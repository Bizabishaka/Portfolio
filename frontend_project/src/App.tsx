  ...
  const portfolioProjects = [
    {
      ...
      imageUrl:
        "https://readdy.ai/api/search-image?query=Modern%20web%20application%20interface%20with%20clean%20design%2C%20minimalist%20dashboard%20layout%20with%20data%20visualization%2C%20professional%20UI%20design%20with%20light%20color%20scheme%2C%20high%20quality%20rendering%2C%20photorealistic&width=600&height=400&seq=1&orientation=landscape",
    },
    {
      id: 2,
      ...
      description:
        "User-centered mobile application design with intuitive navigation",
      imageUrl:
        "https://readdy.ai/api/search-image?query=Mobile%20app%20interface%20design%20mockup%20on%20smartphone%2C%20clean%20minimalist%20UI%20design%2C%20professional%20color%20scheme%2C%20light%20mode%20interface%2C%20high%20quality%20rendering%2C%20photorealistic%2C%20white%20background&width=600&height=400&seq=2&orientation=landscape",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      imageUrl:
        "https://readdy.ai/api/search-image?query=Brand%20identity%20design%20elements%20including%20logo%2C%20business%20cards%2C%20and%20stationery%20on%20white%20desk%2C%20professional%20minimalist%20design%2C%20light%20color%20palette%2C%20high%20quality%20rendering%2C%20photorealistic&width=600&height=400&seq=4&orientation=landscape",
    },
    {
      id: 5,
          ...
          <div className="container mx-auto px-6 py-16 relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-700 mb-10 leading-relaxed">
                👋 Hi, I'm Zakaria, a passionate Frontend Developer specializing
                in React.js + Vite and Mobile App Development with Flutter. I
                build fast, responsive, and user-friendly web and mobile
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                A showcase of my recent projects and creative work across
                various domains.
              </p>
            </div>
